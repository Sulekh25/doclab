<div align="center">
  ...
  <a href="https://sulekh25.github.io/doclab/"><strong>➥ Live Demo</strong></a>
...
```bash
sudo git clone https://github.com/Sulekh25/doclab.git
```

Windows:

```bash
git clone https://github.com/Sulekh25/doclab.git
```
